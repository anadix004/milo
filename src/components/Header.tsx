  ...
  return (
    <header className="fixed top-0 inset-x-0 w-full p-6 md:p-8 flex justify-between items-start z-[100] pointer-events-none mix-blend-screen">
      ...
      <div className="flex gap-4 items-center flex-row pointer-events-auto">
        ...
        <button 
          onClick={onChatClick}
          className="relative w-10 h-10 rounded-full flex items-center justify-center bg-black/20 border border-white/10 backdrop-blur-md text-white/70 hover:text-white hover:bg-white/10 transition-all group"
        >
          <motion.div
            animate={{ 
              y: [0, -2, 0],
