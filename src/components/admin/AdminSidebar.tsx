...
export default function AdminSidebar({ activeTab, setActiveTab }: AdminSidebarProps) {
  ...
  return (
    <div className="w-64 h-full bg-white/[0.02] border-r border-white/5 backdrop-blur-3xl flex flex-col pt-12 pb-6 flex-shrink-0">
        ...
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              ...
              <Icon size={18} className={clsx("transition-colors", isActive ? "text-cyan-400" : "group-hover:text-purple-400")} />
