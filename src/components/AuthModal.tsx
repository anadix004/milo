...
export default function AuthModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  const renderContent = () => (
    <div className={clsx("w-full relative", !isMobile && "mt-8")}>
      <div className={clsx("flex justify-between items-center mb-8", isMobile ? "px-0" : "-mt-2 mb-12")}>
      ...
      <AnimatePresence mode="wait">
          ...
          >
            <div className="text-center space-y-4">
              <div className="w-16 h-16 bg-white/5 rounded-2xl mx-auto flex items-center justify-center border border-white/5 rotate-3">
                 <UserCircle size={28} className="text-white/40" />
              </div>
            ...
            <div className="space-y-4 pt-4">
               ...
               <div className="relative py-4">
                  ...
                  <div className="relative flex justify-center text-[8px] font-mono"><span className="bg-black/90 px-4 text-white/10 uppercase tracking-widest font-black italic">Advanced Auth</span></div>
               </div>
        ...
        {currentStep === "login" && (
          ...
          >
            ...
            <form onSubmit={executeLogin} className="space-y-6">
               ...
               <button type="button" onClick={() => recoverPassword(formData.email)} className="block w-full text-center font-mono text-[8px] text-white/20 uppercase tracking-widest hover:text-white transition-colors font-black pb-8">
        ...
        {currentStep === "signup-credentials" && (
          ...
          >
            ...
            <div className="space-y-8">
               ...
               <button onClick={handleNext} className="w-full bg-white text-black py-6 rounded-full font-black uppercase tracking-widest text-[10px] hover:scale-[1.02] active:scale-95 transition-all shadow-xl flex items-center justify-center gap-3 mb-8">
                  Next Step
                  <ArrowRight size={16} />
               </button>
            </div>
        ...
        {currentStep === "signup-handle" && (
          ...
          >
            ...
            >
               ...
               <button disabled={isSyncing} className="w-full bg-emerald-500 text-black py-6 rounded-full font-black uppercase tracking-widest text-[10px] hover:scale-[1.02] active:scale-95 transition-all shadow-2xl shadow-emerald-500/20 flex items-center justify-center gap-3 mb-8">
        ...
        {currentStep === "identity" && (
          ...
          >
            ...
            <div className="text-center pt-8 border-t border-white/5 pb-8">
               <button 
                 onClick={resetAndClose} 
  ...
  if (isMobile) {
    return (
      <BottomSheet isOpen={isOpen} onClose={resetAndClose} snapHeight="98vh">
        {renderContent()}
      </BottomSheet>
    );
  }
